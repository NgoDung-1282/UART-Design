...
#
# Script generated by Vivado on Fri Aug 09 08:48:54 +0700 2024
...
# script info
echo -e "fifo.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo xil_defaultlib.fifo xil_defaultlib.glbl -log elaborate.log
}
